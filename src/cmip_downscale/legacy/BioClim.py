...
class quarter_class:
    ...
    def __init__(
        self, target_variable, quarter_variable, agg_target, agg_quarter, find_fun
    ):
    ...
    def _comp_quarters_(
        self, target_variable, quarter_variable
    ):  # ,array1, array2, agg1, agg2, fun2
        """
    ...
    def comp_quarters_array(self):
        ...
        :rtype: xarray
        """
        res_arr = xr.apply_ufunc(
            self._comp_quarters_,  # function to apply
            self.target_variable,
            self.quarter_variable,  # pass arguments.
            input_core_dims=[["month"], ["month"]],
            vectorize=True,
            dask="parallelized",
            # let dask handle the parallelization
...
class BioClim:
    ...
    def bio8(self):
        ...
        :rtype: xarray
        """
        res_arr = quarter_class(
            target_variable=self.tas["tas"],
