...
ap.add_argument(
    "-s", "--source_id", type=str, help="Source model (GCM), e.g. MPI-ESM1-2-LR, string"
)
ap.add_argument(
    "-i", "--institution_id", type=str, help="Institution ID, e.g. MPI-M, string"
)
ap.add_argument("-t", "--table_id", type=str, help="table id, e.g. Amon, string")
ap.add_argument(
    "-a", "--activity_id", type=str, help="activity id, e.g. ScenarioMIP, string"
)
ap.add_argument(
    "-e", "--experiment_id", type=str, help="experiment id, e.g. ssp585, string"
)
ap.add_argument(
    "-m", "--member_id", type=str, help="ensemble member, e.g. r1i1p1f1, string"
)
ap.add_argument(
    "-rs",
    "--refps",
...
ap.add_argument(
    "-o", "--output", type=str, help="output directory, needs to exist, string"
)
ap.add_argument(
    "-esfg",
    "--esgf",
